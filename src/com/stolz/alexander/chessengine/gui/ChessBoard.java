...
public ChessBoard() {
	...
	images = new Image[8][8];
		...
		images[7][0] = new Image("file:resource/blackrook.png"); images[6][0] = new Image("file:resource/blackknight.png");
		images[5][0] = new Image("file:resource/blackbishop.png"); images[4][0] = new Image("file:resource/blackking.png");
		images[3][0] = new Image("file:resource/blackqueen.png"); images[2][0] = new Image("file:resource/blackbishop.png");
		images[1][0] = new Image("file:resource/blackknight.png"); images[0][0] = new Image("file:resource/blackrook.png");
		// second row (black)
		images[7][1] = new Image("file:resource/blackpawn.png"); images[6][1] = new Image("file:resource/blackpawn.png");
		images[5][1] = new Image("file:resource/blackpawn.png"); images[4][1] = new Image("file:resource/blackpawn.png");
		images[3][1] = new Image("file:resource/blackpawn.png"); images[2][1] = new Image("file:resource/blackpawn.png");
		images[1][1] = new Image("file:resource/blackpawn.png"); images[0][1] = new Image("file:resource/blackpawn.png");
		
		// empty squares
		for(int x = 0; x < 8; x++){
			for(int y = 2; y < 6; y++){
				images[x][y] = new Image("file:resource/empty.png");
			}
		}
		
		// third row (white)
		images[7][6] = new Image("file:resource/whitepawn.png"); images[6][6] = new Image("file:resource/whitepawn.png");
		images[5][6] = new Image("file:resource/whitepawn.png"); images[4][6] = new Image("file:resource/whitepawn.png");
		images[3][6] = new Image("file:resource/whitepawn.png"); images[2][6] = new Image("file:resource/whitepawn.png");
		images[1][6] = new Image("file:resource/whitepawn.png"); images[0][6] = new Image("file:resource/whitepawn.png");
		// fourth row of renders (white)
		images[7][7] = new Image("file:resource/whiterook.png"); images[6][7] = new Image("file:resource/whiteknight.png");
		images[5][7] = new Image("file:resource/whitebishop.png"); images[4][7] = new Image("file:resource/whiteking.png");
		images[3][7] = new Image("file:resource/whitequeen.png"); images[2][7] = new Image("file:resource/whitebishop.png");
		images[1][7] = new Image("file:resource/whiteknight.png"); images[0][7] = new Image("file:resource/whiterook.png");
	...
	public void drawmove(final int si, int sj, int ti, int tj){
		...
		Image newimage = new Image("file:resource/" +piece);
