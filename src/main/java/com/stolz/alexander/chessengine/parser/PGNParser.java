...
public class PGNParser {
    ...
    public String getPgn(ChessBoard b, String whiteName, String blackName) {
        return getPgn(b, whiteName, blackName, null, null, null);
    }

    public String getPgn(ChessBoard b, String whiteName, String blackName, String event, String site, String result) {
        ...
        if (!FEN_START_POSITION.equals(b.initialFen)) {
    ...
    public void parsePgn(String pgn) {
        ...
        fenStartPosition = FEN_START_POSITION;
    ...
    public void setBoard(ChessBoard b, String pgn) {
        parsePgn(pgn);
